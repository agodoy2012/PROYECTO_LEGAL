<%@ Page Title="Arreglo_Extra_Judicial" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Arreglo_Extra_Judicial.aspx.cs" Inherits="SEGUIMIENTO_LEGAL.Arreglo_Extra_Judicial" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Arreglo Extra Judicial</li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-danger">
            ...
            <div class="box-header with-border">
                    ...
                    <i class="fa fa-thumbs-up"></i><h3 class="box-title">Arreglo Extra Judicial</h3>
             </div>

            <div class="box-body">

                <table id="lista_arreglo_extra" class="table table-striped table-hover" style='width:100%' ">
                <thead>
                    <tr>
                        <th>No. Expediente</th>
    ...
    <script src="Scripts/js/arreglo_extra_judicial.js"></script>
