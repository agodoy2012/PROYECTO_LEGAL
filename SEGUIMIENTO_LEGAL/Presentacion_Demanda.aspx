<%@ Page Title="Preparacion" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Presentacion_Demanda.aspx.cs" Inherits="SEGUIMIENTO_LEGAL.Presentacion_Demanda" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Presentación Demanda</li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-danger">
            ...
            <div class="box-header with-border">
                    ...
                    <i class="fa fa-file-text"></i><h3 class="box-title">Presentación Demanda</h3>
             </div>
 ...
 <div id="tramitar_proceso" class="modal fade" role="dialog">
    ...
    <script src="Scripts/js/presentacion.js"></script>
