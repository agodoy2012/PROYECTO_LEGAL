<%@ Page Title="Arreglo_Judicial" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Arreglo_Judicial.aspx.cs" Inherits="SEGUIMIENTO_LEGAL.Arreglo_Judicial" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Arreglo Judicial</li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-danger">
            ...
            <div class="box-header with-border">
                    ...
                    <i class="fa fa-gavel"></i><h3 class="box-title">Arreglo Judicial</h3>
             </div>

            <div class="box-body">

                <table id="lista_arreglo" class="table table-striped table-hover" style='width:100%' ">
                <thead>
                    <tr>
                        <th>No. Expediente</th>
    ...
    <script src="Scripts/js/arreglo_judicial.js"></script>
