<%@ Page Title="Preparacion_Demanda" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Preparacion_Demanda.aspx.cs" Inherits="SEGUIMIENTO_LEGAL.Preparacion_Demanda" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Preparación Demanda</li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-danger">
            ...
            <div class="box-header with-border">
                    ...
                    <i class="fa fa-folder-o"></i><h3 class="box-title">Preparación Demanda</h3>
             </div>

            <div class="box-body">

                <table id="lista_preparacion" class="table table-striped table-hover" style='width:100%' ">
                <thead>
                    <tr>
                        <th>No. Expediente</th>
    ...
    <script src="Scripts/js/preparacion.js"></script>
